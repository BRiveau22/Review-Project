...
public:
	...
	auto Action1_Input_Handler(int choice);
	void Generate_Action1_UI();
	auto Action2_Input_Handler(int choice);
	void Generate_Action2_UI();
	auto Action3_Input_Handler(int choice);
	void Generate_Action3_UI();
	auto Action4_Input_Handler(int choice);
	void Generate_Action4_UI();
	auto Action5_Input_Handler(int choice);
	void Generate_Action5_UI();
	auto Action6_Input_Handler(int choice);
	void Generate_Action6_UI();
	auto Home_Input_Handler(int choice);
